      ...
      <div className="space-y-6">
        ...
        {employees.length === 0 ? (
          <button
            ...
            className="w-1/2 min-h-96 border-4 border-dashed border-gray-600 hover:border-cyan-500 rounded-xl flex items-center justify-center transition-colors group"
          >
